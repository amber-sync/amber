...
export const Terminal: React.FC<TerminalProps> = ({ logs, isRunning, variant = 'default', className = '' }) => {
  ...
  return (
    <div className={`bg-white dark:bg-[#1e1e1e] rounded-lg p-4 font-mono text-xs text-gray-800 dark:text-green-400 h-64 overflow-hidden flex flex-col shadow-inner border border-gray-200 dark:border-gray-700 transition-colors duration-300 ${className}`}>
