    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
          Compare storage requirements for {numBackups} backups of a {formatStorage(avgBackupSize)} dataset
          with {changeRate * 100}% of files changing between backups.
        </p>
      </div>
            ...
            <div className="h-full p-8 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900 dark:text-white">Traditional Backups</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Complete copy every time</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl p-4 border border-orange-200 dark:border-orange-800">
                    <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Total Files Stored</p>
            ...
            <div className="h-full p-8 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-gray-900 dark:text-white">Time Machine Mode</h4>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Smart incremental with hard links</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl p-4 border border-teal-200 dark:border-teal-800">
                    <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Physical Files Stored</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-6">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-gray-700">
              ...
              <span className="font-mono font-semibold text-gray-900 dark:text-white">{formatStorage(avgBackupSize)}</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-gray-700">
              <span className="text-gray-600 dark:text-gray-400">Number of backups:</span>
              <span className="font-mono font-semibold text-gray-900 dark:text-white">{numBackups}</span>
            </div>
            <div className="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-gray-700">
              <span className="text-gray-600 dark:text-gray-400">Change rate:</span>
              <span className="font-mono font-semibold text-gray-900 dark:text-white">{changeRate * 100}%</span>
            </div>
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-2 border-indigo-200 dark:border-indigo-800 rounded-xl p-6">
          ...
          <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            <li className="flex items-start gap-2">
              <Icons.ArrowRight size={16} className="text-indigo-600 dark:text-indigo-400 flex-shrink-0 mt-0.5" />
